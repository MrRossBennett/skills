...
1. Write a plain-English `##` title. An emoji is welcome when it helps scanning.
2. Add a one- or two-sentence lead-in.
3. Show one small fenced code block unless a diagram or data shape explains the idea better.
4. Prefer ending the section on the code block.
